...
(function($, global){
    ...
    $(function(){
        ...
        var $loading = $("#loading"),
            $load = $(".load", $loading),
            $check = $(".check", $loading),
            $checkResult = $(".check-result", $loading), checkCanvas = false,
            $checkCanvas = $(".check-canvas", $checkResult),
            $checkCanvasSpan = $("span", $checkCanvas), checkCanvasText = false,
            $checkCanvasText = $(".check-canvas-text", $checkResult),
            $checkCanvasTextSpan = $("span", $checkCanvasText), checkRange = false,
            $checkRange = $(".check-range", $checkResult),
            $checkRangeSpan = $("span", $checkRange),
            $select = $(".select", $checkResult),
            $sorry = $(".sorry", $checkResult), result = false;
