...
(function($, global){
	...
	Shape = function(){
	    ...
	    this.initAttributes = function(){
	        //获取当前属性
            var $attributePanel = $('#tool-shape-attribute-panel'),
	...
	Line = function(){
		...
		this.setPoint = function(pointList){
		    var startPoint = pointList.getStart(),
    ...
    Stroke = function(){
        ...
        this.initAttributes = function(){
            //获取当前属性
            var $attributePanel = $('#tool-stroke-attribute-panel'),
                width = $('.width',$attributePanel).eq(0).val(),
                opacity = $('.opacity',$attributePanel).eq(0).val(),
                color = $('#tool-wrap .tool .color').eq(0).val(),              
                shadowOffsetX = $('.shadow-offsetx',$attributePanel).eq(0).val(),
    ...
    Eraser = function(){
        ...
        this.init = function(){
            //获取当前属性
            var $attributePanel = $('#tool-eraser-attribute-panel'),
                width = $('.width',$attributePanel).eq(0).val(),
                opacity = $('.opacity',$attributePanel).eq(0).val(),
                shadowOffsetX = $('.shadow-offsetx',$attributePanel).eq(0).val(),
                shadowOffsetY = $('.shadow-offsety',$attributePanel).eq(0).val(),
    ...
    FloodFill = function(){
        ...
        this.init = function(){
            //获取当前属性
            var $attributePanel = $('#tool-flood-fill-attribute-panel'),
                color = $('#tool-wrap .tool .color').eq(0).val(),
                allowance = parseInt($('.allowance',$attributePanel).eq(0).val(), 10) || 1,
    ...
    Text = function(){
        ...
        this.initAttributes = function(){           
            //获取当前属性
            var $attributePanel = $('#tool-text-attribute-panel'),
                opacity = $('.opacity',$attributePanel).eq(0).val(),
    ...
    global.painter.model.toolModel.Arrow = Arrow;
